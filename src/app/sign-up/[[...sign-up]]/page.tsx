  ...
  return(
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full items-center lg:items-start lg:w-1/2 flex flex-col gap-4">
        <h1 className="text-2xl xsm:text-4xl md:text-6xl font-bold">Sign up to your account</h1>
        ...
        <SignUp.Root>
          <SignUp.Step name="start" className='flex flex-col gap-4'>
            ...
            <div className="flex flex-col gap-4">
              ...
              <Clerk.Field name="username">
                <Clerk.Input placeholder='Username' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white '/>
                <Clerk.FieldError className='text-red-300 text-sm ' />
              </Clerk.Field>

              <Clerk.Field name="emailAddress">
                <Clerk.Input placeholder='E-mail' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white '/>
                <Clerk.FieldError className='text-red-300 text-sm ' />
              </Clerk.Field>
              ...
              <SignUp.Captcha />
              <SignUp.Action submit className="bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center cursor-pointer">
                Sign Up
              </SignUp.Action>
            </div>
          ...
          <SignUp.Step name='verifications'>
            <SignUp.Strategy name="email_code" >
              <h1 className='text-sm mb-4'>Check your e-mail code</h1>  
              <Clerk.Field name="code" className='flex flex-col gap-4 mb-4'>
                <Clerk.Input placeholder='Verification Code' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white '/>
                <Clerk.FieldError className='text-red-300 text-sm' />
              </Clerk.Field>
              <SignUp.Action submit className="bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center cursor-pointer">
                Verify
          ...
          <Link href="/sign-in" className="bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center">Already have an account?</Link>
