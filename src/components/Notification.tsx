...
const Notification = () => {
  ...
  return (
    <div className="relative mb-4">
      <div
        className="cursor-pointer py-2 px-4 rounded-full hover:bg-[#181818] flex items-center gap-4"
      ...
      {open && (
        <div className="absolute left-full top-0 ml-2 p-4 rounded-lg bg-white text-black flex flex-col gap-4 w-max z-50">
